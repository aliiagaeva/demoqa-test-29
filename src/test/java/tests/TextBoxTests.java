...
public class TextBoxTests
{
    ...
    void fillFormTest() {
        ...
        $("label[for='hobbies-checkbox-1']").scrollIntoView(true).click();
        $("#uploadPicture").uploadFromClasspath("1000.jpg");
        $("#currentAddress").scrollIntoView(true).setValue("SPb");
        $("#subjectsInput").scrollIntoView(true).click();
        $("#subjectsInput").setValue("Math").pressEnter();
        $("#state").scrollIntoView(true).click();
        $("#react-select-3-option-3").scrollIntoView(true).click();
        $("#city").scrollIntoView(true).click();
        $("#react-select-4-option-0").scrollIntoView(true).click();
